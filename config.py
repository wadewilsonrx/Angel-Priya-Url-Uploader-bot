...
class Config(object):
    ...
    TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6187618587:AAEcJNrdzBi22WxqqvgRs8HBr5H0XoiBocU")
    ...
    AUTH_USERS = set(int(x) for x in os.environ.get("AUTH_USERS", "5911954612").split())
    ...
    LAZY_DEVELOPER = set(int(x) for x in os.environ.get("LAZY_ADMIN", "5911954612").split())
